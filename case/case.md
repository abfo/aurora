...
This folder contains files to print a case for the Adafruit BrainCraft version of Aurora. 

## Design

I used [OpenSCAD](https://openscad.org/) to design the case. The .scad files (case, lid, button, strut) can be edited using this software.

## Print

The .stl files (case, lid, button, strut) are ready to slice and print. You'll need two struts and one of each of the other parts. 
